...
export const preloadHandlebarsTemplates = async function () {
    ...
    const templatePaths = [
        ...
        'systems/sla-industries/templates/actor/parts/effects-tab.hbs',
        'systems/sla-industries/templates/actor/parts/bio-traits-tab.hbs',
        'systems/sla-industries/templates/actor/parts/stat-row.hbs',
        ...
        'systems/sla-industries/templates/item/parts/item-toxicant.hbs',
        'systems/sla-industries/templates/item/parts/item-effects.hbs',
        'systems/sla-industries/templates/item/parts/item-skill.hbs',
        'systems/sla-industries/templates/item/parts/item-trait.hbs',
        'systems/sla-industries/templates/item/parts/item-item.hbs',
        'systems/sla-industries/templates/item/parts/item-discipline.hbs',
